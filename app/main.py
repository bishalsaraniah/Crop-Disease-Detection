            ...
            if "Error" not in prediction and "Unknown" not in prediction:
                ...
                with st.spinner('Getting treatment recommendations...'):
                    ...
                    if st.button("Save Results"):
                        ...
                        filename = f"{results_dir}/{crop_selection}_{prediction}_{timestamp}.txt"
                        
                        with open(filename, "w") as f:
                            f.write(f"Crop: {crop_selection}\n")
                            f.write(f"Disease: {prediction}\n\n")
                            f.write("Treatment Recommendations:\n")
                            f.write(treatment)
                            
                        # Save the image
                        img_filename = f"{results_dir}/{crop_selection}_{prediction}_{timestamp}.jpg"
                        img_for_gemini.save(img_filename)
